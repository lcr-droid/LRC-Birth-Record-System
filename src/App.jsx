...
function App() {
  ...
  // Helper function for record field extraction
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      {/* Print Certificate Modal - EXACT match to the HTML/CSS layout */}
        ...
        <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 animate-fade-in">
          <div className="bg-white rounded-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden shadow-2xl animate-slide-up flex flex-col" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="flex-1 overflow-y-auto p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6 pb-4 border-b border-gray-200">
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="e.g., JANUARY 16, 2003"
                  />
                </div>
                <div>
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="e.g., DECEMBER 23, 2002"
                  />
                </div>
                <div>
              ...
              {/* Certificate Preview - EXACT match to HTML/CSS layout */}
              <div className="border-t border-gray-200 pt-4">
                ...
                <div ref={printRef} className="relative bg-white border border-gray-400 shadow-xl overflow-hidden" style={{ fontFamily: "'Times New Roman', Times, serif", width: '100%' }}>
                  ...
                  <div className="relative py-8 px-8 z-10">
                    ...
                    {/* Dotted Line */}
                    <div className="border-b border-dotted border-black w-full my-3"></div>
                    ...
                    <div className="flex justify-end mb-4">
                      <div className="text-right">
                        <p className="text-sm font-bold">{printData.date ? new Date(printData.date).toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' }).toUpperCase() : '___________'}</p>
                      </div>
                    </div>
                    ...
                    <div className="space-y-1 text-sm mb-6">
                      <div className="flex"><span className="font-bold w-48">PRN</span><span className="w-4">:</span><span className="flex-1 ml-2">{printData.prn || '___________'}</span></div>
                      <div className="flex"><span className="font-bold w-48">LCR Registry Number</span><span className="w-4">:</span><span className="flex-1 ml-2">{printData.lcrNumber || getFieldValue(selectedRecord, ['lcr', 'registry']) || '___________'}</span></div>
                      <div className="flex"><span className="font-bold w-48">Date of Registration</span><span className="w-4">:</span><span className="flex-1 ml-2">{printData.registrationDate || getFieldValue(selectedRecord, ['date of registration']) || '___________'}</span></div>
                      <div className="flex"><span className="font-bold w-48">Name of Child</span><span className="w-4">:</span><span className="flex-1 ml-2">{printData.childName || getFieldValue(selectedRecord, ['name of child']) || '___________'}</span></div>
                      <div className="flex"><span className="font-bold w-48">Sex</span><span className="w-4">:</span><span className="flex-1 ml-2">{printData.sex || getFieldValue(selectedRecord, ['sex', 'gender']) || '___________'}</span></div>
                      <div className="flex"><span className="font-bold w-48">Date of Birth</span><span className="w-4">:</span><span className="flex-1 ml-2">{printData.dateOfBirth || getFieldValue(selectedRecord, ['date of birth']) || '___________'}</span></div>
                      <div className="flex"><span className="font-bold w-48">Place of Birth</span><span className="w-4">:</span><span className="flex-1 ml-2">{printData.placeOfBirth || getFieldValue(selectedRecord, ['place of birth']) || '___________'}</span></div>
                      <div className="flex"><span className="font-bold w-48">Name of Mother</span><span className="w-4">:</span><span className="flex-1 ml-2">{printData.motherName || getFieldValue(selectedRecord, ['name of mother']) || '___________'}</span></div>
                      <div className="flex"><span className="font-bold w-48">Nationality</span><span className="w-4">:</span><span className="flex-1 ml-2">FILIPINO</span></div>
                      <div className="flex"><span className="font-bold w-48">Name of Father</span><span className="w-4">:</span><span className="flex-1 ml-2">{printData.fatherName || getFieldValue(selectedRecord, ['name of father']) || '___________'}</span></div>
                      <div className="flex"><span className="font-bold w-48">Nationality</span><span className="w-4">:</span><span className="flex-1 ml-2">FILIPINO</span></div>
                      <div className="flex"><span className="font-bold w-48">Date of Marriage of Parents</span><span className="w-4">:</span><span className="flex-1 ml-2">{printData.marriageDate || getFieldValue(selectedRecord, ['date of marriage']) || '___________'}</span></div>
                      <div className="flex"><span className="font-bold w-48">Place of Marriage of Parents</span><span className="w-4">:</span><span className="flex-1 ml-2">{printData.marriagePlace || getFieldValue(selectedRecord, ['place of marriage']) || '___________'}</span></div>
                    </div>

                    {/* THIS CERTIFICATION Statement */}
                    <div className="mb-5">
                      <p className="text-sm">
                        THIS CERTIFICATION is issued to <strong className="underline">{printData.issuedTo || getFieldValue(selectedRecord, ['name of child']) || '___________'}</strong> upon his/her request.
                      </p>
                    </div>
                    ...
                    <div className="flex justify-between items-start mb-6">
                      <div className="text-left">
                        <p className="font-bold text-sm underline">{printData.municipalCivilRegistrar || '____________________'}</p>
                        <p className="text-xs font-bold">CLERK III</p>
                      </div>
                      <div className="text-right">
                        <p className="font-bold text-sm underline">{printData.asstRegistrationOfficer || '____________________'}</p>
                    ...
                    <div className="space-y-0.5 text-sm mb-4">
                      ...
                      <p><span className="font-bold">Amount Paid:</span> {printData.amountPaid || '___________'}</p>
                    ...
                    {/* NOTE */}
                    <div className="mt-3 text-xs italic font-bold" style={{ fontFamily: "'Monotype Corsiva', cursive" }}>
